...
app.controller('VideoCtrl',function($scope,$rootScope,RESTClient,Category,$state,URL,TVPlay,$timeout,$stateParams,CanvasEdit,ScreenShot,Track)
{
...
/*
    ...
    $scope.playControl.next=function()
    {
        TVPlay.controller.nextFrame(0.2,function(time){
            ...
            $scope.tracksInfo=Track.tracksInfo;
            $scope.curTracks=Track.curTracks;
            console.log("the info of track");
    console.log($scope.curTracks);
    ...
    {
        window.open("index.html#item/"+programId);
    }
